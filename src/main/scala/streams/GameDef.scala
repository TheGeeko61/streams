...
trait GameDef {
  ...
  case class Block(b1: Pos, b2: Pos) {
     ...
     */
    def isStanding: Boolean = b1 == b2 //TODO: remove flag when testing complete

    /**
     * Returns `true` if the block is entirely inside the terrain.
     */
    def isLegal: Boolean = terrain(b1) && terrain(b2) //TODO: remove flag when testing complete
  }
}
