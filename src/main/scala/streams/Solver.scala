...
trait Solver extends GameDef {
   ...
   */
  //TODO: Remove flag when testing complete
  ...
  def neighborsWithHistory(b: Block, history: List[Move]):
    Stream[(Block, List[Move])] = {
      b.legalNeighbors map {
        case (block, path) => (block, path :: history)
      } toStream
    }
   ...
   */
  //TODO: Remove flag when testing is complete
   ...
   */
  //TODO: Remove flag once testing is completed
   ...
   */
  //TODO: Remove flag once testing complete
   ...
   */
  //TODO: Remove flag after testing complete
